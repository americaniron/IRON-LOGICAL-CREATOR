...
const OpenAIVideoPanel: React.FC = () => {
  ...
  const { isKeyRequired, isReady, saveKey } = useApiKeyManager('openai');
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      const videoUrl = await generateOpenAIVideo(prompt);
  ...
  }, [prompt, imageFile, setIsLoading, setError, setResultUrl, addAsset, handleApiError]);
  ...
  }, [resultUrl, upscaleStrength, setIsUpscaling, setUpscaleError, setUpscaledUrl, handleApiError]);
